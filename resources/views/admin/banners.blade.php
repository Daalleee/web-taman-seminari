            ...
            <div class="p-5 flex-1 flex flex-col">
                ...
                <div class="pt-4 border-t border-primary/5 flex justify-end gap-2 mt-auto">
                    ...
                    <form method="POST" class="inline">
                        @csrf @method('DELETE')
                        <button type="button" @click="window.dispatchEvent(new CustomEvent('show-delete-confirm', { detail: { title: 'Hapus Banner?', message: 'Yakin ingin menghapus banner ini? Tindakan ini tidak bisa dibatalkan.', action: '{{ route('admin.banners.delete', $banner) }}' } }))" class="text-red-500 hover:bg-red-50 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-1.5">
